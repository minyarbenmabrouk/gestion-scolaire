...
<router-link :to="{name: 'Addetudiant'}" class="btn btn-outline-light">
...
<tbody>
<tr v-for="etd in etudiants" :key="etd.id">
<td><img :src="etd.imageetudiant" width="70"
...
@click="deleteetudiant(etd.id)">Supprimer</button></td>
</tr>
</tbody>
</table>
